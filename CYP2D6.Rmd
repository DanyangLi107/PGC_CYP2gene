...
```{r}
ref <- readxl::read_excel('CYP2D6_allele_definition_table.xlsx', sheet=1)
...
# include alleles that do not contain SNPs outside the SNP list, this step could select star allele that do not contain any SNPs in the SNP list (such as *13, *5 so need to remove these snps in later steps)
...
# because all included SNPs have rsid, change this to colnames
